...
const categories = [
  ...
  { name: "Tools & Improvement", products: 4, image: bootle },
...
const bgColors = [
  ...
  "bg-dark", "bg-light", "bg-secondary", "bg-light", "bg-info"
];
        ...
        {categories.map((category, index) => (
          <div key={index} className="col-6 col-md-5 col-lg-3 d-flex justify-content-center ">
            <div>
              ...
              <div className={`category-card text-center border cards ${bgColors[index % bgColors.length]}`}>
                <img
